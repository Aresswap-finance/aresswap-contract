...
contract AresswapToken is ERC20, ERC20Permit, Pausable, AccessControl {
    ...
    constructor(address trustedForwarder) ERC20("Aresswap Token", "ARES") ERC20Permit("Aresswap Token") {
